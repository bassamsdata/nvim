-- thanks to https://github.com/briangwaltney/paren-hint.nvim/blob/main/lua/paren-hint/init.lua
local parens = {
	[")"] = "(",
	["}"] = "{",
	["]"] = "[",
...
M.add_ghost_text = function()
	...
	if
		not M.opts.show_same_line_opening and open_line_num == current_line_num
	then
		return
	end
