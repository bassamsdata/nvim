-- source : https://github.com/OXY2DEV/nvim/blob/main/lua/scripts/cmdline.lua
-- gist:  https://gist.github.com/OXY2DEV/af052d26cf5a37e1725c9cc7e4d68e8c
local cmd = {}
...
--- 7. Return
cmd.open = function()
  local w = cmd.conf.width < 1 and math.floor(vim.o.columns * cmd.conf.width)
    or cmd.conf.width
  local h = 3
...
vim.ui_attach(
  cmd.ns,
  { ext_cmdline = true, ext_popupmenu = true },
  function(event, ...)
